...
public class WindowExample8 {
	public static void main(String[] args) {
		...
		UpdateDataSaver saver = new UpdateDataSaver();
		...
		// 버튼 이벤트
		text4.addActionListener(new AddActionListener(table, text1, text2, text3, text4, jdbcManager, saver));		
		button1.addActionListener(new AddActionListener(table, text1, text2, text3, text4, jdbcManager, saver));
		...
		exitBtn.addActionListener(new ExitActionListener(jdbcManager));
