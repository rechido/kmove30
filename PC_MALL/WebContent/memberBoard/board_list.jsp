...
<BODY leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	int dbcount = 0; //  DB 안에 글 갯수 저장 변수%>
			<%
				try {
					...
					String sql = "select b_id, b_name, b_title, b_content, ";
 ...
 %>
				...
				<td width=180 height=30 valign=middle align=right><a href="write_form.jsp"><img src="img/m_bt10.gif" border=0 align=absmiddle></a> <a
					href="board_list.jsp"><img src="img/m_bt06.gif" border=0 align=absmiddle></a></td>
				<td width=10>&nbsp;</td>
			</tr>
		</table>
	</form>
