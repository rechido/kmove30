...
<%!
     String b_name ,b_title,b_content,b_date,b_ip,mailto;
...
try {
   ...
   String sql="select b_id, b_name, b_title, b_content, to_char(b_date,'yy-mm-dd'),b_hit, b_ip, ref, step, anslevel from member_board where b_id="+bid; 
