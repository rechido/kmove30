...
Connection con = pool.getConnection("ora8");
	...
	sql = "insert into member_board (B_ID, B_NAME, B_TITLE, B_CONTENT, B_HIT, B_IP, REF, STEP, ANSLEVEL, B_DATE )values(?,?,?,?,?,?,?,?,?,sysdate)";
	PreparedStatement pstmt = con.prepareStatement(sql);
	pstmt.setInt(1,b_id);
	pstmt.setString(2,(String) session.getAttribute("pid"));
