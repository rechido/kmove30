...
<BODY bgcolor="#EEEEE0">
	...
	<table border=1 width=550 height=30 bordercolor=black>
		<tr>
			<td align=center bgcolor=0063ce><font size=3 color=#FFFFFF><b>회
						원 가 입</b></td>
		</tr>
	</table>
	<br>
	<form name=form_name method=post action="insert.jsp">
		<table border=1 cellpadding=3 cellspacing=0 width=550 valign=top
			align=center>
			<tr>
				<td width=90 bgcolor=#ccffff>회원 성명<font color=red> *</font></td>
				<td width=340 bgcolor=white><input type=text name=name size=20
					maxlength=20 value="">&nbsp성명은 빈칸없이 입력하세요.</td>
			</tr>
			<tr>
				<td bgcolor=#ccffff>주민등록번호<font color=red> *</font></td>
				<td bgcolor=white><input type=text name=ssn1 size=6 maxlength=6
					value=""> - <input type=text name=ssn2 size=7 maxlength=7
					value=""></td>
			</tr>
			<tr>
				<td bgcolor=#ccffff>회원 id<font color=red> *</font></td>
				<td bgcolor=white align=absmiddle><input type=text name=uid
					size=10 maxlength=16> <input type="button" name="id_chk"
					value="ID중복 체크"
					OnClick="openuid_check(document.form_name.uid.value)">
					&nbsp; 5자 이상의 영문이나 숫자로 입력하세요.</td>
			</tr>
			<tr>
				<td bgcolor=#ccffff>비밀번호<font color=red> *</font></td>
				<td bgcolor=white><input type=password name=pwd size=8
					maxlength=12"> &nbsp;5자 이상의 영문이나 숫자로 입력하세요.</td>
			</tr>
			<tr>
				<td bgcolor=#ccffff>비밀번호확인<font color=red> *</font></td>
				<td bgcolor=white><input type=password name=repwd size=8
					maxlength=12 value="" style="width: 80">&nbsp다시 한번 입력해 주세요.
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td bgcolor=white><input type=text name=addr size=50
					maxlength=60 value=""></td>
			</tr>
			<tr>
				<td bgcolor=#ccffff>전화번호</td>
				<td bgcolor=white><input type=text name=tel1 size=4 maxlength=4
					value=""> - <input type=text name=tel2 size=4 maxlength=4
					value=""> - <input type=text name=tel3 size=4 maxlength=4
					value=""></td>
			</tr>
			<tr>
				<td bgcolor=#ccffff>e-mail</td>
				<td bgcolor=white valign=middle><input type=text name=email
					size=30 maxlength=30 value=""></td>
			</tr>
			<tr>
			...
			<tr bgcolor=#00FF00>
				<td colspan=3 align=left><font color=red> * </font><font
					color=black>표시항목은 반드시 입력하십시요.</font>&nbsp;&nbsp; <input
					type="button" name="formcheck" value="가   입" OnClick="form_check()">
