<%@ page import="java.sql.*,oracle.dbpool.*" errorPage="/error.jsp"
...
<%
	if (session.getAttribute("pid") == null) {
		...
		try {
			...
			String sql2 = "insert into basket(id,product_id,user_id,qty,buydate,temp1,temp2 ) values(" + count
					+ "," + pc_calnum + ",'" + p_id + "',1,sysdate,'GG','Y')";
