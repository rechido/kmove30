...
public class MultiPart {
	...
	// 주어진 이름에 해당하는 업로드 파일의 이름을 리턴하는 메서드
	public ArrayList<String> getFileNames(String fieldName) throws UnsupportedEncodingException {
	...
	public void saveFiles(String fieldName, String path) throws Exception {
		Iterator itr = items.iterator();
	      while (itr.hasNext()) {
	           FileItem item = (FileItem) itr.next();
	           if (item.isFormField()) {
